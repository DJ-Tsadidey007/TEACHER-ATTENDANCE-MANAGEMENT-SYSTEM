...
namespace NPBIOMETRIC.attendanceDataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`Staff_ID` = ?) AND ((? = 1 AND `Staff_Name` IS NULL" +
                ") OR (`Staff_Name` = ?)) AND ((? = 1 AND `Time_Arrived` IS NULL) OR (`Time_Arriv" +
                "ed` = ?)) AND ((? = 1 AND `Verified` IS NULL) OR (`Verified` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Table1` SET `Staff_ID` = ?, `Staff_Name` = ?, `Time_Arrived` = ?, `Remarks` = ?, `Verified` = ? WHERE ((`Staff_ID` = ?) AND ((? = 1 AND `Staff_Name` IS NULL) OR (`Staff_Name` = ?)) AND ((? = 1 AND `Time_Arrived` IS NULL) OR (`Time_Arrived` = ?)) AND ((? = 1 AND `Verified` IS NULL) OR (`Verified` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NPBIOMETRIC.Properties.Settings.Default.attendanceConnectionString;
        }
        ...
        public virtual int Fill(attendanceDataSet.Table1DataTable dataTable) {
        ...
        public virtual attendanceDataSet.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            attendanceDataSet.Table1DataTable dataTable = new attendanceDataSet.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(attendanceDataSet.Table1DataTable dataTable) {
        ...
        public virtual int Delete(string Original_Staff_ID, string Original_Staff_Name, global::System.Nullable<global::System.DateTime> Original_Time_Arrived, string Original_Verified) {
            ...
            if ((Original_Verified == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_Verified));
            }
        ...
        public virtual int Update(string Staff_ID, string Staff_Name, global::System.Nullable<global::System.DateTime> Time_Arrived, string Remarks, string Verified, string Original_Staff_ID, string Original_Staff_Name, global::System.Nullable<global::System.DateTime> Original_Time_Arrived, string Original_Verified) {
            if ((Staff_ID == null)) {
                throw new global::System.ArgumentNullException("Staff_ID");
            }
            else {
            ...
            if ((Original_Verified == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_Verified));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Staff_Name, global::System.Nullable<global::System.DateTime> Time_Arrived, string Remarks, string Verified, string Original_Staff_ID, string Original_Staff_Name, global::System.Nullable<global::System.DateTime> Original_Time_Arrived, string Original_Verified) {
            return this.Update(Original_Staff_ID, Staff_Name, Time_Arrived, Remarks, Verified, Original_Staff_ID, Original_Staff_Name, Original_Time_Arrived, Original_Verified);
        }
    }
